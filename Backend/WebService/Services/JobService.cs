...
namespace WebService.Services
{
    public class JobService
    {
        ...
        public JobService(BeFitDbContext beFitDbContext, WebPushService webPushService)
        {
            _beFitDbContext = beFitDbContext;
            _webPushService = webPushService;
        }

        public async Task NotifyUser(bool isDrink, bool isWorkout)
        {
            var dateTime = DateTime.UtcNow.AddHours(TimeOffsetConstants.TimeOffset);
